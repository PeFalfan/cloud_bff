...
public class RoleController {
    ...
    @PostMapping("/roles")
    public ResponseModel handleGraphQL(@RequestBody String graphqlQuery) {
        try {
            logger.info("Received GraphQL query: {}", graphqlQuery);
            
            // Trim the query to remove any extra whitespace
            graphqlQuery = graphqlQuery.trim();
            
            // Use the raw GraphQL query directly
            if (graphqlQuery.contains("roles")) {
